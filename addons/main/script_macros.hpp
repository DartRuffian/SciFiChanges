...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "sft_fnc_recompile") then {sft_recompiles = []; sft_fnc_recompile = {{call _x} forEach sft_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; sft_recompiles pushBack _recomp;
#else
